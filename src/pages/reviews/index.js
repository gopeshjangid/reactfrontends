...
const reviews = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      fetch(`${process.env.NEXT_PUBLIC_APIURL}/rating`, {
        method: "POST",
        mode: "cors",
  ...
  useEffect(() => {
    fetch(`${process.env.NEXT_PUBLIC_APIURL}/getAllRating`, {
      method: "GET",
      headers: {
        "Content-type": "application/json",
        Accept: "application/json",
  ...
  return (
    <div>
      <section>
        <Head>
          <title>Reviews-Get Pro Writer</title>

          <meta
            name="description"
            content="We’re so grateful to our clients who wrote these reviews. Our writing staff is made up of well-trained writers who have a keenly honed sense of what works."
          />
          <meta
            name="robots"
            content="noindex, nofollow, max-image-preview:large"
          />
          <link rel="canonical" href="https://getprowriter.com/reviews/" />
          ...
          <meta property="og:title" content="Get Pro Writer - Reviews" />
          <meta
            property="og:description"
            content="We’re so grateful to our clients who wrote these reviews. Our writing staff is made up of well-trained writers who have a keenly honed sense of what works."
          />
          <meta property="og:url" content="https://getprowriter.com/reviews/" />
          <meta
            property="og:image"
          ...
          <meta
            ...
            content="2021-12-23T11:17:26+00:00"
          />
          <meta
            property="article:modified_time"
            content="2022-03-10T12:03:56+00:00"
          />
          <meta name="twitter:card" content="summary" />
          <meta name="twitter:title" content="Get Pro Writer - Reviews" />
          <meta
