        ...
        <div className="row align-items-baseline">
          <div className="col-lg-3">
            <ul className="nav nav-pills flex-column acunt_dsh" role="tablist">
              ...
              {/* <li className="nav-item">
                <Link className="nav-link" href="/accountsettingservices">
                  Services
                </Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" href="/accountsettingsubscriptions">
                  Subscriptions
                </Link>
              </li> */}
              <li className="nav-item">
                <Link className="nav-link" href="/viewprofile">
                  Account Setting
                </Link>
              </li>
                          ...
                          <div class="modal-content border-0">
                            ...
                            <div class="modal-body">
                              ...
                              >
                                ...
                                {/* <Link href="/login"><button type="button" className="btn_set2" onClick={(e) => this.create(e)}>Login</button></Link> */}
                              </form>
                            </div>
                          </div>
                        </div>
