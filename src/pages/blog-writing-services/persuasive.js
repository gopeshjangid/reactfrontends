  ...
  return (
    <div>
      <section className="top_sec p-0">
        <Head>
          <title>persuasive blog post - Get Pro Writer</title>

          <meta
            name="description"
            content="Are you struggling to make your blog post more persuasive? Our company provides the writer to write you best persuasive blog post."
          />
          <meta
            name="robots"
          ...
          <link
            rel="canonical"
            href="https://getprowriter.com/blog-writing-services/persuasive/"
          />
          ...
          <meta
            property="og:title"
            content="persuasive blog post - Get Pro Writer"
          />
          <meta
          ...
          <meta
            property="og:url"
            content="https://getprowriter.com/blog-writing-services/persuasive/"
          />
          <meta
            property="og:image"
          ...
          <meta
            ...
            content="2022-07-02T10:46:03+00:00"
          />
          <meta
            property="article:modified_time"
            content="2022-07-02T10:54:51+00:00"
          />
      ...
      <section className="rws_sec">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src=" https://getprowriter.com/writer/img/Top-notch.webp"
                alt="No-match-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Extremely-creative.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src=" https://getprowriter.com/writer/img/Diverse-writers.webp"
                alt="Online-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src=" https://getprowriter.com/writer/img/Boost-Business-image.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src=" https://getprowriter.com/writer/img/Original-writing-(1).webp"
          ...
          <div className="row">
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Charles-Beckham.webp"
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src=" https://getprowriter.com/writer/img/Boris-Walker.webp"
                    alt="Marcela-Vella"
                    className="testi_box-img"
                  />
