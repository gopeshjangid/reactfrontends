  ...
  return (
    <div>
      <section className="top_sec p-0">
        <Head>
          <title>Professional Blog Writers - Get Pro Writer</title>

          <meta
            name="description"
            content="Getprowriter.com provides the Best Professional Blog Writers who can create &amp; maintain multiple blogs for your online business."
          />
          <meta
            name="robots"
          ...
          <link
            rel="canonical"
            href="https://getprowriter.com/blog-writing-services/professional/"
          />
          ...
          <meta
            property="og:title"
            content="Professional Blog Writers - Get Pro Writer"
          />
          <meta
          ...
          <meta
            property="og:url"
            content="https://getprowriter.com/blog-writing-services/professional/"
          />
          <meta
            property="og:image"
          ...
          <meta
            ...
            content="2022-06-18T06:12:02+00:00"
          />
          <meta
            property="article:modified_time"
            content="2022-06-18T06:19:56+00:00"
          />
      ...
      <section className="rws_sec">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src=" https://getprowriter.com/writer/img/Professional-blog-writer.webp"
                alt="No-match-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src=" https://getprowriter.com/writer/img/Blog-creative-writer.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Versatile-blog-writer.webp"
                alt="Online-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src=" https://getprowriter.com/writer/img/Professional-writer.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Original-content-2.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src=" https://getprowriter.com/writer/img/Expertise-writer-2.webp"
                alt="Expertise"
                className="rws-img"
              />
            </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Dan-Richardson.webp"
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Gaston-Froidevaux.webp"
                    alt="Marcela-Vella"
                    className="testi_box-img"
                  />
