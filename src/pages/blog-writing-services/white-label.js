  ...
  return (
    <div>
      <section className="top_sec p-0">
        <Head>
          <title>white label blog writing - Get Pro Writer</title>

          <meta
            name="description"
            content="GetProwriter.com is a white label blog writing company that delivers high quality, custom blog article under 24 hours."
          />
          <meta
            name="robots"
          ...
          <link
            rel="canonical"
            href="https://getprowriter.com/blog-writing-services/white-label/"
          />
          ...
          <meta
            property="og:title"
            content="white label blog writing - Get Pro Writer"
          />
          <meta
          ...
          <meta
            property="og:url"
            content="https://getprowriter.com/blog-writing-services/white-label/"
          />
          <meta
            property="og:image"
          ...
          <meta
            ...
            content="2022-06-20T07:53:04+00:00"
          />
          <meta
            property="article:modified_time"
            content="2022-06-20T07:57:18+00:00"
          />
      ...
      <section className="rws_sec">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/White-label-writer.webp"
                alt="No-match-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Creative-blog-professionals.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Highly-blog-writers.webp"
                alt="Online-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Increase-users.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src=" https://getprowriter.com/writer/img/Original-writers.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src=" https://getprowriter.com/writer/img/Expertise-writers.webp"
                alt="Expertise"
                className="rws-img"
              />
            </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Ron-Jones.webp"
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src=" https://getprowriter.com/writer/img/Diana-Hastings.webp"
                    alt="Marcela-Vella"
                    className="testi_box-img"
                  />
