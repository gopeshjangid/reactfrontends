  ...
  return (
    <div>
      <section className="top_sec p-0">
        <Head>
          <title>real estate blog writing service - Get Pro Writer</title>

          <meta
            name="description"
            content="Get Professional real estate blog writing service at Getprowriter.com and get your real estate blog on top of google searches."
          />
          <meta
            name="robots"
          ...
          <link
            rel="canonical"
            href="https://getprowriter.com/blog-writing-services/real-estate/"
          />
          ...
          <meta
            property="og:title"
            content="real estate blog writing service - Get Pro Writer"
          />
          <meta
          ...
          <meta
            property="og:url"
            content="https://getprowriter.com/blog-writing-services/real-estate/"
          />
          <meta
            property="og:image"
          ...
          <meta
            ...
            content="2022-06-21T05:03:29+00:00"
          />
          <meta
            property="article:modified_time"
            content="2022-06-21T05:11:08+00:00"
          />
      ...
      <section className="rws_sec">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src=" https://getprowriter.com/writer/img/Guaranteed.webp"
                alt="No-match-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Real-Estate-unmatched.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Committed-best-content.webp"
                alt="Online-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src=" https://getprowriter.com/writer/img/Real-Estate-Industry-blogs.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src=" https://getprowriter.com/writer/img/Expertise-5.webp"
                alt="Expertise"
                className="rws-img"
              />
            </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Rupert-Donald.webp"
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Charlotte-Cook.webp"
                    alt="Marcela-Vella"
                    className="testi_box-img"
                  />
