  ...
  return (
    <div>
      <section className="top_sec p-0">
        <Head>
          <title>Freelance Finance Writer - Get Pro Writer</title>

          <meta
            name="description"
            content="Informative Finance Content! GetProWriter is known to offer outstanding freelance finance writer services to clients across the industry. Our writers are highly experienced in writing professional and quality content for different niches. Get In Touch Select ServiceContent Writing Excellent writers for freelance finance content with GetProWriter! Impressive finance blog posts for your business. Attractive Posts"
          />
          <meta
            name="robots"
          ...
          <link
            rel="canonical"
            href="https://getprowriter.com/freelance-writing-services/finance/"
          />
          ...
          <meta
            property="og:title"
            content="Freelance Finance Writer - Get Pro Writer"
          />
          <meta
          ...
          <meta
            property="og:url"
            content="https://getprowriter.com/freelance-writing-services/finance/"
          />
          <meta
            name="twitter:image"
          ...
          <meta
            ...
            content="2022-11-09T07:13:57+00:00"
          />
          <meta
            property="article:modified_time"
            content="2022-11-09T11:03:50+00:00"
          />
          ...
          <div className="row">
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Robert-Williams.webp"
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Albert-Ross.webp"
                    alt="Marcela-Vella"
                    className="testi_box-img"
                  />
