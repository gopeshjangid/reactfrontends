  ...
  return (
    <div>
      <section className="top_sec p-0">
        <Head>
          <title>Freelance Business Writer- Get Pro Writer</title>

          <meta
            name="description"
            content="GetProWriter is a sought-after name when it comes to offering freelance business writer services."
          />
          <meta
            name="robots"
          ...
          <link
            rel="canonical"
            href="https://getprowriter.com/freelance-writing-services/business/"
          />
          ...
          <meta
            property="og:title"
            content="Freelance Business Writer- Get Pro Writer"
          />
          <meta
          ...
          <meta
            property="og:url"
            content="https://getprowriter.com/freelance-writing-services/business/"
          />
          <meta
            property="og:image"
          ...
          <meta
            ...
            content="2022-11-12T05:19:31+00:00"
          />
      ...
      <section className="rws_sec">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/pexels-mart-production-7222722.jpg"
                alt="No-match-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Streamline-Writers.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/You-Will-Witness-Versatility-In-Our-Content-(1).webp"
                alt="Online-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Attractive-Content.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Top-Writers.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Freelance-Business-Writing.webp"
                alt="Expertise"
                className="rws-img"
              />
            </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Sarah-Montana.webp"
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Oliver-Hastings.webp"
                    alt="Marcela-Vella"
                    className="testi_box-img"
                  />
