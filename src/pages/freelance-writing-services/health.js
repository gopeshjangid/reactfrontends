  ...
  return (
    <div>
      <section className="top_sec p-0">
        <Head>
          <title>Freelance Health Writer- Get Pro Writer</title>

          <meta
            name="description"
            content="GetProWriter is an industry-leading company, offering freelance health writer services to clients."
          />
          <meta
            name="robots"
          ...
          <link
            rel="canonical"
            href="https://getprowriter.com/freelance-writing-services/health/"
          />
          ...
          <meta
            property="og:title"
            content="Freelance Health Writer- Get Pro Writer"
          />
          <meta
          ...
          <meta
            property="og:url"
            content="https://getprowriter.com/freelance-writing-services/health/"
          />
          <meta
            property="og:image"
          ...
          <meta
            ...
            content="2022-11-10T08:21:55+00:00"
          />
          <meta
            property="article:modified_time"
            content="2022-11-10T10:20:48+00:00"
          />
      ...
      <section className="rws_sec">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Our-Writers-Are-Truly-Talented.webp"
                alt="No-match-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Professionals.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Reader-Friendly-Content-(1).webp"
                alt="Online-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Accurate-Information.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Ideas-Are-Original.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Freelance-Health-Writing.webp"
                alt="Expertise"
                className="rws-img"
              />
            </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Tim-Ray-2.webp"
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Taylor-K.webp"
                    alt="Marcela-Vella"
                    className="testi_box-img"
                  />
