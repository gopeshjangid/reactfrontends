						...
						<div className="row">
							...
							<div className="faq-inner">
								...
								{this.state.User && this.state.User.map((friend) => {
									return (
										<div className="faq-item bg_set accordion-item" onClick={this.handleToggleVisibility} key={friend._id}>

											<h2 className="faq_item-h3 accordion-header" id={friend._id}>
												<button className="faq-plus size accordion-button bg-transparent text-white accordion-button shadow-none collapsed" type="button" data-bs-toggle="collapse" data-bs-target={"#" + "s" + friend._id} aria-expanded="false" aria-controls={"s" + friend._id}>
													{friend.title}
												</button>
											</h2>

											<div id={"s" + friend._id} className="bg-white accordion-collapse collapse" aria-labelledby={friend._id}>
