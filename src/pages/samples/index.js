...
class samples extends Component {
  ...
  async componentDidMount() {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_APIURL}/getworkSamples`,
      {
        method: "GET",
        mode: "cors",
        headers: {
      ...
      <div>
        {this.state.isLoading ? (
          ...
          <section className="samp_sec">
            <Head>
              <title>Samples - Get Pro Writer</title>

              <meta
                name="description"
                content="Check our content writing samples, and you’ll be convinced that we are the best content writing service in the industry."
              />
              <meta
                name="robots"
                content="noindex, nofollow, max-image-preview:large"
              />
              <link rel="canonical" href="https://getprowriter.com/samples/" />
              <meta
                name="generator"
              ...
              <meta property="og:title" content="Samples - Get Pro Writer" />
              <meta
              ...
              <meta
                property="og:url"
                content="https://getprowriter.com/samples/"
              />
              <meta
                property="og:image"
              ...
              <meta
                ...
                content="2021-12-23T11:09:41+00:00"
              />
              <meta
                property="article:modified_time"
                content="2022-04-19T08:03:13+00:00"
              />
              <meta name="twitter:card" content="summary" />
              <meta name="twitter:title" content="Samples - Get Pro Writer" />
              <meta
