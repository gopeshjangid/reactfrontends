  ...
  return (
    <div>
      <section className="top_sec p-0">
        <Head>
          <title>business ghostwriter - Get Pro Writer</title>

          <meta
            name="description"
            content="You may think the best business ghostwriters cost a fortune. At getprowriter.com we make it easy to hire the best business ghostwriters at an affordable price."
          />
          <meta
            name="robots"
          ...
          <link
            rel="canonical"
            href="https://getprowriter.com/ghostwriting-services/business/"
          />
          ...
          <meta
            property="og:title"
            content="business ghostwriter - Get Pro Writer"
          />
          <meta
          ...
          <meta
            property="og:url"
            content="https://getprowriter.com/ghostwriting-services/business/"
          />
          <meta
            property="og:image"
          ...
          <meta
            ...
            content="2022-05-26T07:19:19+00:00"
          />
          <meta
            property="article:modified_time"
            content="2022-05-26T07:23:59+00:00"
          />
      ...
      <section className="rws_sec">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Business-Expectations.webp"
                alt="No-match-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Uniqueness.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Business-writers.webp"
                alt="Online-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Business-presence.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Originilty.webp"
          ...
          <div className="row">
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Daniel-Hernandez.webp"
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Cabdirisaaq-Hogol-Caafi.webp"
                    alt="Marcela-Vella"
                    className="testi_box-img"
                  />
