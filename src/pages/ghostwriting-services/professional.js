  ...
  return (
    <div>
      <section className="top_sec p-0">
        <Head>
          <title>
            Hire Professional Ghostwriter | Professional Ghostwriting Services |
          </title>

          <meta
            name="description"
            content="At getprowriter.com, a credible and authentic platform, you can get the best results. The expertise of our professional ghostwriter is phenomenal."
          />
          <meta
            name="robots"
          ...
          <link
            rel="canonical"
            href="https://getprowriter.com/ghostwriting-services/professional/"
          />
          ...
          <meta
            property="og:title"
            content="Hire Professional Ghostwriter | Professional Ghostwriting Services |"
          />
          <meta
          ...
          <meta
            property="og:url"
            content="https://getprowriter.com/ghostwriting-services/professional/"
          />
          <meta
            property="og:image"
          ...
          <meta
            ...
            content="2022-03-12T09:40:35+00:00"
          />
          <meta
            property="article:modified_time"
            content="2022-05-18T08:02:33+00:00"
          />
      ...
      <section className="rws_sec">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Quality-content.webp"
                alt="No-match-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Creativity-Innovation.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Specialized-extremely.webp"
                alt="Online-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Redefine-Ghostwriter.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Unique-content.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Expertise-ahead-and-leauge.webp"
                alt="Expertise"
                className="rws-img"
              />
            </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Jack-Connor.webp"
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Mason-Robert.webp"
                    alt="Marcela-Vella"
                    className="testi_box-img"
                  />
