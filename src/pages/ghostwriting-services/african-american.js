  ...
  return (
    <div>
      <section className="top_sec p-0">
        <Head>
          <title>Ghostwriting Services - Get Pro Writer</title>

          <meta
            name="description"
            content="Getprowriter.com offers professional custom writings, written from scratch by a qualified african- american ghostwriters."
          />
          <meta
            name="robots"
          ...
          <link
            rel="canonical"
            href="https://getprowriter.com/ghostwriting-services/african-american/"
          />
          ...
          <meta
            property="og:title"
            content="Ghostwriting Services - Get Pro Writer"
          />
          <meta
          ...
          <meta
            property="og:url"
            content="https://getprowriter.com/ghostwriting-services/african-american/"
          />
          <meta
            property="og:image"
          ...
          <meta
            ...
            content="2022-05-07T10:14:50+00:00"
          />
          <meta
            property="article:modified_time"
            content="2022-05-13T05:21:11+00:00"
          />
          ...
          <div className="row align-items-center">
            <div className="col-md-6">
              <h1 className="top_Sec-h1 mt-3 p-0">
                Top African American Ghostwriters!
              </h1>
              <h2 className="top_Sec-h2">
                Reliable African American Writers Now|
              </h2>
              <p className="top_Sec-p">
                If you are looking for a professional writer who understands the
                culture of African American communities, GetProWriter is the
                right place where you can find the best ghostwriters. We work
                with a team of native speakers and professional writers who have
                great experience in writing interesting, persuasive, and unique
        ...
        <div className="container">
          <div className="row">
            <h2 className="writing_sec-h2">
              Looking for trusted African American Ghostwriters for your
              business? Well, GetProWriter is here to help!
            </h2>
            <span className="writing_sec-spa">* * * * *</span>
            <p className="writing_sec-p">
              Take your project to incredible heights by taking our African
              American Ghostwriters on board.
            </p>
            ...
            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Understand Requirements</h3>
              </div>
            </div>

            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Project Specific</h3>
              </div>
            </div>
            ...
            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Highly Qualifications</h3>
              </div>
            </div>

            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Certified Ghostwriters</h3>
              </div>
            </div>

            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Narrative Builders</h3>
              </div>
            </div>

            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Engaging Flow</h3>
              </div>
            </div>
      ...
      <section className="rws_sec">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/African-american.webp"
                alt="No-match-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/African.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Writer.webp"
                alt="Online-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Image.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Originality-Guaranteed.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Expertise-ghostwriters.webp"
                alt="Expertise"
                className="rws-img"
              />
            </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/pexels-cottonbro-7507786.webp"
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/pexels-cottonbro-5378700-150x150.webp"
                    alt="Marcela-Vella"
                    className="testi_box-img"
                  />
...
export default africanamerican;
