  ...
  return (
    <div>
      <section className="top_sec p-0">
        <Head>
          <title>Social Media Ghostwriter - Get Pro Writer</title>

          <meta
            name="description"
            content="Are you looking for a social media ghostwriter to help boost your blog? Our ghostwriting services for businesses will make your brand shine online!"
          />
          <meta
            name="robots"
          ...
          <link
            rel="canonical"
            href="https://getprowriter.com/ghostwriting-services/social-media/"
          />
          ...
          <meta
            property="og:title"
            content="Social Media Ghostwriter - Get Pro Writer"
          />
          <meta
          ...
          <meta
            property="og:url"
            content="https://getprowriter.com/ghostwriting-services/social-media/"
          />
          <meta
            property="og:image"
          ...
          <meta
            ...
            content="2022-05-07T10:55:10+00:00"
          />
          <meta
            property="article:modified_time"
            content="2022-05-17T08:07:13+00:00"
          />
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-6">
              <h1 className="top_Sec-h1 mt-3 p-0">Leading SM Ghostwriters!</h1>
              <h2 className="top_Sec-h2"> Social Media Content Wizards|</h2>
              <p className="top_Sec-p">
                GetProWriter is a top name when it comes to social media
                ghostwriting services. Our company can help you get the content
                you need for your social media platforms, whether it’s Facebook,
                Twitter, or even LinkedIn. Our writers create high-quality
                content that is sure to engage your audience.
              </p>
            </div>
        ...
        <div className="container">
          <div className="row">
            <h2 className="writing_sec-h2">
              Want to get industry-qualified social media ghostwriters? Get
              GetProWriter now!
            </h2>
            <span className="writing_sec-spa">* * * * *</span>
            <p className="writing_sec-p">
              Improve your personal or business brand with our best social media
              ghostwriters.
            </p>
            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Organized Approach</h3>
              </div>
            </div>

            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Approved Expertise</h3>
              </div>
            </div>

            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Keywords Focussed</h3>
              </div>
            </div>

            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Unmatched Quality</h3>
              </div>
            </div>

            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Trends Experts</h3>
              </div>
            </div>
      ...
      <section className="rws_sec">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Social-media-quality.webp"
                alt="No-match-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Social-media-creative-1-1024x585.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Social-media-focus.webp"
                alt="Online-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Business-reputation-(1).webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/SM-Individuals-Enterprises.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Social-media-Expertise.webp"
                alt="Expertise"
                className="rws-img"
              />
            </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Wilson-Taylor.webp"
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Davies-OBrien.webp"
                    alt="Marcela-Vella"
                    className="testi_box-img"
                  />
