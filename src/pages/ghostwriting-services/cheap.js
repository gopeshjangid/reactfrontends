  ...
  return (
    <div>
      <section className="top_sec p-0">
        <Head>
          <title>Cheap Ghostwriters - Get Pro Writer</title>

          <meta
            name="description"
            content="You can hire ghostwriters inexpensively with Getprowriter. The ultimate place to find experienced and original ghostwriting professionals online."
          />
          <meta
            name="robots"
          ...
          <link
            rel="canonical"
            href="https://getprowriter.com/ghostwriting-services/cheap/"
          />
          ...
          <meta
            property="og:title"
            content="Cheap Ghostwriters - Get Pro Writer"
          />
          <meta
          ...
          <meta
            property="og:url"
            content="https://getprowriter.com/ghostwriting-services/cheap/"
          />
          <meta
            property="og:image"
          ...
          <meta
            ...
            content="2022-05-12T05:27:50+00:00"
          />
          <meta
            property="article:modified_time"
            content="2022-05-12T06:11:49+00:00"
          />
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-6">
              <h1 className="top_Sec-h1 mt-3 p-0">Cheap Ghostwriters Now!</h1>
              <h2 className="top_Sec-h2">
                Affordable Ghostwriters For Projects|{" "}
              </h2>
              <p className="top_Sec-p">
                GetProWriter is a known name offering cheap ghostwriters for
                hire. If you need a professional to help write your content, our
                writers can do it for you. We have a wide range of services that
                allow us to cover all kinds of content. You can trust us with
                any type of writing assignment you have.
              </p>
            </div>
        ...
        <div className="container">
          <div className="row">
            <h2 className="writing_sec-h2">
              Are you looking for highly skilled ghostwriters at affordable
              prices? Well, GetProWriter is here to serve you!
            </h2>
            <span className="writing_sec-spa">* * * * *</span>
            <p className="writing_sec-p">
              Add an edge to your writing output by hiring our ghostwriters with
              vast experience.
            </p>
            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Qualified Writers</h3>
              </div>
            </div>
            ...
            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Affordable Writers</h3>
              </div>
            </div>

            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Industry Recognized</h3>
              </div>
            </div>

            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Diverse Writing Styles</h3>
              </div>
            </div>
            ...
            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Easy Understandable</h3>
              </div>
            </div>
      ...
      <section className="rws_sec">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Cheap-Ghostwriters.webp"
                alt="No-match-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Ghostwriters-Imagination.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Writer-Maintaining-standards.webp"
                alt="Online-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Ghostwriting-services-safe-hands.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Writers-originality.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/GPW-Expertise.webp"
                alt="Expertise"
                className="rws-img"
              />
            </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Evelyn.webp"
            ...
            <div className="col-md-6 d-flex">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    src="https://getprowriter.com/writer/img/Robert-Hailey.webp"
                    alt="Marcela-Vella"
                    className="testi_box-img"
                  />
