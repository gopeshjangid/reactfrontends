  ...
  return (
    <div>
      <section className="top_sec p-0">
        <Head>
          <title>fiction ghostwriter - Get Pro Writer</title>

          <meta
            name="description"
            content="Hire the most talented fiction ghostwriter who can finish your writing project on time and always submit the best content in form of books, novels and more."
          />
          <meta
            name="robots"
          ...
          <link
            rel="canonical"
            href="https://getprowriter.com/ghostwriting-services/fiction/"
          />
          ...
          <meta
            property="og:title"
            content="fiction ghostwriter - Get Pro Writer"
          />
          <meta
          ...
          <meta
            property="og:url"
            content="https://getprowriter.com/ghostwriting-services/fiction/"
          />
          <meta
            property="og:image"
          ...
          <meta
            ...
            content="2022-05-25T05:18:04+00:00"
          />
          <meta
            property="article:modified_time"
            content="2022-05-25T05:23:07+00:00"
          />
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Fiction Redefined</h3>
              </div>
            </div>
            ...
            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Unique Styles</h3>
              </div>
            </div>
            ...
            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Trained & Flexible</h3>
              </div>
            </div>

            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Sharp Characterisation</h3>
              </div>
            </div>

            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Amazing Plots</h3>
              </div>
            </div>

            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Engaging Draft</h3>
              </div>
            </div>

            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Versatile Creators</h3>
              </div>
            </div>

            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">No Delays</h3>
              </div>
            </div>

            <div className="col-md-3">
              <div className="wr-b">
                <h3 className="box-h3">Authenticity Assured</h3>
              </div>
            </div>
        ...
        <div className="container">
          <div className="row">
            <h2 className="writing_sec-h2 rws-h2 p-0">
              Quality-Assured Fiction Ghostwriting Services At GetProWriter
            </h2>
            <span className="writing_sec-spa">* * * * *</span>
            <p className="writing_sec-p">
              GPW services are available, accessible, and affordable.
            </p>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Unmatched-work.webp"
                alt="No-match-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Marvellous-content.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Fiction-ghostwriters-Afraid-to-make-it-loud.webp"
                alt="Online-review"
                className="rws-img"
              />
            </div>
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Expertise-tough-competition.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Crafted-to-prcision.webp"
            ...
            <div className="col-md-6 rws_Sec-6">
              <img
                src="https://getprowriter.com/writer/img/Experience.webp"
                alt="Expertise"
                className="rws-img"
              />
            </div>
                ...
                <ol className="m-0 d-flex align-items-center p-0">
                  ...
                  <li className="in_li">
                    <span className="spa_h2">
                      Fiction created on time and as per your expectations
                    </span>
                  </li>
                </ol>
              </div>
              ...
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <img
                    ...
                    className="testi_box-img"
                  />
                  <h3 className="testi_box-h3">Dody El Dragy</h3>
                  <p className="testi_box-p">Mketing, Executive</p>
                </div>
              </div>
            </div>
                ...
                <div className="faq-inner">
                  ...
                  <div className="faq-item p-0 bg_set accordion-item">
                    ...
                    >
                      ...
                      >
                        Is it okay to hire ghostwriters for my fiction novel?
                      </button>
                    </h2>
