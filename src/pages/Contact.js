					...
					<div className="row">
						<div className="col-md-4">
							<div className="ct_box">
								<ul className="ct-ul">
									<li className="ct-li"><span><i aria-hidden="true" className="fas fa-address-card ct-icon"></i></span>
										<span className="ct-span">R-51, Kailashpuri, Near Manoharpura, Jagatpura, Jaipur 302017</span>
									</li>
								</ul>
							</div>
						</div>
						...
						<div className="col-md-4">
							<div className="ct_box">
								<ul className="ct-ul">
									<li className="ct-li"><span><i aria-hidden="true" className="fas fa-envelope-open-text ct-icon"></i></span>
						...
						<div className="col-md-4">
							<div className="ct_box">
								<ul className="ct-ul">
									<li className="ct-li"><span><i aria-hidden="true" className="fas fa-phone-volume ct-icon"></i></span>
