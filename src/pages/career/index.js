...
const career = () => {
  ...
  useEffect(() => {
    setIsLoading(true);
    fetch(`${process.env.NEXT_PUBLIC_APIURL}/getcareers`, {
      method: "GET",
      headers: {
      ...
      {isLoading ? (
        ...
        <>
          <section className="ab_sec  d-flex justify-content-center align-items-center">
            <Head>
              <title>Career - Get Pro Writer</title>

              <meta
                name="description"
                content="Do you want to become getprowriter.com’s next writer in your area of expertise? Build your career with the one of the best content writing services."
              />
              <meta
                name="robots"
                content="noindex, nofollow, max-image-preview:large"
              />
              <link rel="canonical" href="https://getprowriter.com/career/" />
              <meta
                name="generator"
              ...
              <meta property="og:title" content="Career - Get Pro Writer" />
              <meta
              ...
              <meta
                property="og:url"
                content="https://getprowriter.com/career/"
              />
              <meta
                property="og:image"
              ...
              <meta
                ...
                content="2021-12-23T11:45:51+00:00"
              />
              <meta
                property="article:modified_time"
                content="2022-04-15T06:44:41+00:00"
              />
              <meta name="twitter:card" content="summary" />
              <meta name="twitter:title" content="Career - Get Pro Writer" />
              <meta
              ...
              <div className="row">
                ...
                <div className="col-md-4">
                  <div className="pab_sec-box">
                    ...
                    {/* <img
                      src="https://getprowriter.com/writer/img/home.png"
                      alt="home"
                ...
                <div className="col-md-4">
                  <div className="pab_sec-box">
                    ...
                    {/* <img
                      src="https://getprowriter.com/writer/img/dollar-symbo.png"
                      alt="dollar"
                      className="pab_box-img"
                    /> */}
                ...
                <div className="col-md-4">
                  <div className="pab_sec-box">
                    ...
                    {/* <img
                      src="https://getprowriter.com/writer/img/heart.png"
                      alt="heart"
                      className="pab_box-img"
                    /> */}
                    <h2 className="pab_box-h2">
                ...
                <div className="col-md-4">
                  <div className="pab_sec-box">
                    ...
                    {/* <img
                      src="https://getprowriter.com/writer/img/leanpub.png"
                      alt="leanpub"
                      className="pab_box-img"
                    /> */}
                ...
                <div className="col-md-4">
                  <div className="pab_sec-box">
                    ...
                    {/* <img
                      src="https://getprowriter.com/writer/img/edit.png"
                      alt="edit"
                      className="pab_box-img"
                    /> */}
                    <h2 className="pab_box-h2">
                ...
                <div className="col-md-4">
                  <div className="pab_sec-box">
                    ...
                    {/* <img
                      src="https://getprowriter.com/writer/img/universal.png"
                      alt="universal"
                      className="pab_box-img"
                    /> */}
                    <h2 className="pab_box-h2">
