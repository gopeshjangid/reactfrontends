...
<div className="container mt-3">
    ...
    <div className="row">
	  <div className="col-sm-3">
	      <h2><img src="writer/img/logo/logo-img.png" className="as-img"/></h2>
			  <br/>

			  <ul className="nav nav-pills flex-column acunt_dsh" role="tablist">
				<li className="nav-item">
				  <Link className="nav-link active" data-bs-toggle="pill" to="#home">Dasboard</Link>
				</li>
				<li className="nav-item">
				  <Link className="nav-link" data-bs-toggle="pill" to="#menu1">Services</Link>
				</li>
				<li className="nav-item">
				  <Link className="nav-link" data-bs-toggle="pill" to="#menu2">Subscriptions</Link>
				</li>
				<li className="nav-item">
				  <Link className="nav-link" data-bs-toggle="pill" to="#menu3">Account Setting</Link>
				</li>
				
				<li className="nav-item">
				  <Link className="nav-link" data-bs-toggle="pill" to="#menu4">Payment Methods</Link>
				</li>
				<li className="nav-item">
	  ...
	  <div className="col-sm-9">
				  ...
				  <div className="tab-content">
				    <h5 className="user_tab1">Welcome to <span className="user_ach">User</span></h5>
					<div id="home" className="container tab-pane active"><br/>
				<div className="row">
				  <div className="col-sm-5">
					<div className="input-group mb-3">
					  <span className="input-group-text user_ser"><i className="fa-solid fa-magnifying-glass"></i></span>
					  <input type="text" className="form-control" placeholder="Username" name="usrname"/>
					</div>
					</div>
				  <div className="col-sm-5">
    				 ...
    				 <div className="card card_box">
						...
						<div className="card-body chatbox">
						    <div className="box-li-view fl_l">
						      <ul><li className="userm_li ">
							        <span className="userm_li_span2">Mod_Alex</span>
									<span className="whats_chat_time"><sub>July 27, 2022, 7:24 pm</sub></span><br/>
							...
							<div className="box-li-view fl_r">
							   <ul><li className="userm_li1">
							         <span className="userm_li_span">ankitpgoyal.115@gmail.com</span>
									 <span className="whats_chat_time"><sub>July 27, 2022, 7:25 pm</sub></span><br/>
									 <span className="user_li_text ">hello, my name is here there lorem spum can see there ot visival can see.</span>
									</li>
								</ul>
							</div>
					  ...
					  <div className="chat_msg">
					    <textarea className="form-control chat_cm" rows="3" id="comment" placeholder="type here...." name="text"></textarea>
						<button type="submit" className="btn btn-primary chat_s_btn">Submit</button>
					...
					<div id="menu3" className="container tab-pane fade"><br/>
									...
									<div className="col-md-4 text-center">
										...
										<p className=""><Link to="/">Edit</Link> <Link to="/">Delete</Link></p>
...
<br/>			 
<button type="submit" className="as-btn_set m-auto">Update</button>{Object.keys(formErrors).length === 0 && isSubmit ? (
		<span className='Success text-dark'>Registeration is Successfull</span>) :('')}
</form>
		</div>
...
<div className="row">
			<h2 className="as-second-row_h2">Default Setting For Managing Your Account</h2>
			<div className="col-md-3"> </div>
	
			<form className="col-md-6" onSubmit={onSubmit}> 
                  <label className="as-lbl">Current Password</label>
                  <input type="password" id="fname" name="currentPassword" onChange={inputChange}  className="as-text_set" />
                  ...
                  <input type="password" id="fname" name="confirmPassword" onChange={inputChange}  className="as-text_set" />
					    ...
					    <div className="col-sm-5">
						 ...
						 <div className="col-sm-7">
						   <div className="d-grid">
								<button type="button" className="btn btn-success btn-block user_addm">Add Payment Method</button>
							  </div>
							  <div className="d-grid">
								<button type="button" className="btn btn-success btn-block">Add Money</button>
							  </div>
						 </div>
					  </div>
