...
import getprimg3 from "../images/gpw-img3.png";
import getprimg4 from "../images/gpw-img4.png";
import Getpt from "../images/Getprowriter.jpg";
...
import Katy from "../images/Katy-Wong.webp";
        ...
        <div className="container">
          <div className="row overlep_sec">
            <div className="col-md-3 overlep_sec1">
              <Image src={getprimg1} alt="gpw" className="overlep_sec-img" />
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <div className="video">
                <Image src={Getpt} alt="Getprowriter" className="count-img" />
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <div className="get_sec-box">
                ...
                <Image src={team} alt="team" className="get_sec-box_img" />
                <p className="get_sec-box_p">
            ...
            <div className="col-md-6">
              <div className="testi_box">
                ...
                <div className="t_sels">
                  <Image src={Katy} alt="Katy-Wong" className="testi_box-img" />
